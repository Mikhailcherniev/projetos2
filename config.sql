...
--
-- Host: 127.0.0.1
-- Tempo de geração: 13/03/2024 às 15:53
...
CREATE TABLE `config` (
  ...
  `titulo_servico` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `subtitulo_servico` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `titulo_trabalho` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `subtitulo_trabalho` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
INSERT INTO `config` (`id`, `nome`, `email`, `senha`, `telefone`, `endereco`, `logo`, `icone`, `instagram`, `twitter`, `linkedin`, `facebook`, `youtube`, `cor`, `titulo_servico`, `subtitulo_servico`, `titulo_trabalho`, `subtitulo_trabalho`, `titulo_equipe`, `subtitulo_equipe`, `titulo_contato`, `subtitulo_contato`, `texto_rodape`) VALUES
